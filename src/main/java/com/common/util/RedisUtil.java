...
public final class RedisUtil {
    ...
    private synchronized static void init() {
        HOST = PropertiesLoader.getProperty("redis.host");
        PORT = Integer.valueOf(PropertiesLoader.getProperty("redis.port"));
        AUTH = PropertiesLoader.getProperty("redis.auth");
        MAX_ACTIVE = Integer.valueOf(PropertiesLoader
                .getProperty("redis.pool.maxActive"));
        MAX_IDLE = Integer.valueOf(PropertiesLoader
                .getProperty("redis.pool.maxIdle"));
        MAX_WAIT = Integer.valueOf(PropertiesLoader
                .getProperty("redis.pool.maxWait"));
        TIMEOUT = Integer.valueOf(PropertiesLoader.getProperty("redis.pool.timeout"));
